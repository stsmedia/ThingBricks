...
func (_ tAccountController) All() string {
...
func (_ tAccountController) Add() string {
	args := make(map[string]string)
...
func (_ tDataStreamController) FindByGroup(
	accountId int64,
	projectId int64,
	dataStreamGroupId int64,
) string {
	args := make(map[string]string)

	revel.Unbind(args, "accountId", accountId)
	revel.Unbind(args, "projectId", projectId)
	revel.Unbind(args, "dataStreamGroupId", dataStreamGroupId)
	return revel.MainRouter.Reverse("DataStreamController.FindByGroup", args).Url
}
...
func (_ tDataStreamController) Add() string {
	args := make(map[string]string)
...
type tDataStreamGroupController struct{}

var DataStreamGroupController tDataStreamGroupController
...
func (_ tDataStreamGroupController) One(
	accountId int64,
	projectId int64,
	id int64,
) string {
	...
	revel.Unbind(args, "projectId", projectId)
	revel.Unbind(args, "id", id)
	return revel.MainRouter.Reverse("DataStreamGroupController.One", args).Url
}

func (_ tDataStreamGroupController) Add() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("DataStreamGroupController.Add", args).Url
}

func (_ tDataStreamGroupController) Update(
	id int64,
) string {
	args := make(map[string]string)

	revel.Unbind(args, "id", id)
	return revel.MainRouter.Reverse("DataStreamGroupController.Update", args).Url
}

func (_ tDataStreamGroupController) Delete(
	accountId int64,
	projectId int64,
	id int64,
) string {
	...
	revel.Unbind(args, "projectId", projectId)
	revel.Unbind(args, "id", id)
	return revel.MainRouter.Reverse("DataStreamGroupController.Delete", args).Url
}
...
func (_ tLoginController) Signin() string {
	args := make(map[string]string)
...
func (_ tProjectController) Add() string {
	args := make(map[string]string)
